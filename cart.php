...
<head>
    ...
    <title>Shopping Cart || Electronics-Shop</title>
    ...
    <div class="row" style="margin-top:10px;">
      <div class="col-md-12"></div>
        <div class="alert alert-success" style="display:none;">
          ...
          echo '</tbody>';
          echo '</table><hr>';
          echo '<a href="update-cart.php?action=empty"><button class="add-to-cart">Empty Cart</button></a>&nbsp;<a href="index.php"><button class="add-to-cart">Continue Shopping</button></a>';
