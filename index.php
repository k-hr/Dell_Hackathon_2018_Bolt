...
<!-- Header Nav ============================================================== -->
  <div class="header-blue">
    <nav class="navbar navbar-default navigation-clean-search">
      <div class="container">
        <div class="navbar-header"><a class="navbar-brand navbar-link" href="index.php">Electronics-Shop</a>
          ...
          <ul class="nav navbar-nav">
            ...
            <!--<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="#">All Catagories <span class="caret"></span></a>
              <ul class="dropdown-menu" role="menu">
                <li><a href="product1.php">Smart Phones</a></li>
                <li><a href="product2.php">Laptops</a></li>
                <li><a href="product3.php">Accessories</a></li>
              </ul>
            </li>-->
          </ul>
         ...
         <div class="carousel-inner" role="listbox">
            ...
            <div class="item active">
               <div class="col-xs-12 col-sm-6 col-md-3 team_columns_item_image">
                  ...
                  <div class="team_columns_item_caption">
                     <h5><a href="product1.php">SmartPhones</a></h5>
                     <hr>
                     <h6>Android</h6>
                  </div>
               </div>
            ...
            <div class="item">
               <div class="col-xs-12 col-sm-6 col-md-3 team_columns_item_image">
                  ...
                  <div class="team_columns_item_caption">
                     <h5><a href="product2.php">Laptops</a></h5>
                     <hr>
                     <h6>HP</h6>
                  </div>
               </div>
            ...
            <div class="item">
               <div class="col-xs-12 col-sm-6 col-md-3 team_columns_item_image">
                  ...
                  <div class="team_columns_item_caption">
                     <h5><a href="product3.php">Accessorries</a></h5>
                     <hr>
                     <h6>Hard Drives</h6>
                  </div>
               </div>
...
<!-- Index Product ============================================================ -->
      <div class="container">
        ...
        echo '<div class="modal-body">';              
              ...
              echo ' 
                      <div class="col-lg-6">
                        <img src="assets/img/product/'.$obj->first_image.'">
                          <br>
                          <p><h3>'.$obj->first.'</h3></p>
                        <p><strong>Units Available</strong>: '.$obj->qty.'</p><br>
                        </div>';

              echo '<div class="col-lg-6"><img src="assets/img/product/'.$obj->second_image.'"></div>
                    <p><h3>'.$obj->second.'</h3></p>
